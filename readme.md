1. Ensure we can listen to when people enter or archive
2. Enter in all slash commands
  * new patient
  * done
  *
3. .on channel join
4. .on channel archive


after a volunteer signs in, we need to see  
  - which channels are active
  - which channels are not currently being helped
